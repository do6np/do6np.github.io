...
```html
<ol>
  <li>Privatsphäre erhöhen und Werbung blocken: <a href="
https://microsoftedge.microsoft.com/addons/detail/ublock-origin/odfafepnkmbhccpbejgmiehpchacaeak?hl=de-DE" target="_blank">uBlock Origin installieren.</a></li>
  <li>Zentrale Bibliotheken und dadurch Tracking blockieren: <a href="
  https://microsoftedge.microsoft.com/addons/detail/decentraleyes/lmijmgnfconjockjeepmlmkkibfgjmla" target="_blank">Decentraleyes installieren.</a><br />Die nach der Installation angezeigte Seite kann i.d.R. ignoriert werden.</li>
